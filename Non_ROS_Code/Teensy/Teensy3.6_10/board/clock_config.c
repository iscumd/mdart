...
- {id: CLKOUT.outFreq, value: 60 MHz, locked: true, accuracy: '0.001'}
...
- {id: LPUARTCLK.outFreq, value: 16 MHz, locked: true, accuracy: '0.001'}
- {id: MCGFFCLK.outFreq, value: 500 kHz, locked: true, accuracy: '0.001'}
- {id: MCGIRCLK.outFreq, value: 32.768 kHz, locked: true, accuracy: '0.001'}
- {id: OSCERCLK.outFreq, value: 16 MHz, locked: true, accuracy: '0.001'}
...
- {id: TPMCLK.outFreq, value: 48 MHz, locked: true, accuracy: '0.001'}
...
- {id: USBPHYPLLCLK.outFreq, value: 480 MHz, locked: true, accuracy: '0.001'}
- {id: USBSLCLK.outFreq, value: 32.768 kHz, locked: true, accuracy: '0.001'}
settings:
...
void BOARD_BootClockRUN(void)
{
    ...
    CLOCK_CONFIG_EnableUsbhs0PhyPllClock(oscConfig_BOARD_BootClockRUN.freq);
