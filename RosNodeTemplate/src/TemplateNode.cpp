...
SamplePublisher = n.advertise<NodeFolder::MsgFileName>(
    "NodeTopicWriting", 1000); // used for sending

ros::Subscriber sub =
    n.subscribe("NodeTopicReading", 1000, FunctionName); // used for recieving
